...
func (c *authClient) Login(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*Tokens, error) {
	out := new(Tokens)
...
func (c *authClient) RefreshToken(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*Tokens, error) {
	out := new(Tokens)
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/auth_v1/auth.proto",
}
